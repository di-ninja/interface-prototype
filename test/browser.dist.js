(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["interface-prototype"] = factory();
	else
		root["interface-prototype"] = factory();
...
var wksExt = __webpack_require__(14);
...
exports.AssertionError = __webpack_require__(100);
...
var assertion = __webpack_require__(128);
...
var expect = __webpack_require__(130);
exports.use(expect);
...
var should = __webpack_require__(131);
exports.use(should);
...
var assert = __webpack_require__(132);
exports.use(assert);
...
var _instanceof = __webpack_require__(94);
...
var getName = __webpack_require__(102);
var getProperties = __webpack_require__(103);
var getEnumerableProperties = __webpack_require__(116);
var config = __webpack_require__(31);
...
var getProperties = __webpack_require__(103);
var isProxyEnabled = __webpack_require__(49);
...
var _hasInstance = _interopRequireDefault(__webpack_require__(33));

var _getPrototypeOf = _interopRequireDefault(__webpack_require__(55));

var _possibleConstructorReturn2 = _interopRequireDefault(__webpack_require__(60));

var _inherits2 = _interopRequireDefault(__webpack_require__(86));

var _classCallCheck2 = _interopRequireDefault(__webpack_require__(47));

var _createClass2 = _interopRequireDefault(__webpack_require__(95));
...
module.exports = __webpack_require__(14).f('hasInstance');
...
var _typeof = __webpack_require__(61);
...
var _Symbol$iterator = __webpack_require__(62);
...
var _Object$setPrototypeOf = __webpack_require__(87);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(37)(Function.call, __webpack_require__(45).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var _Symbol$hasInstance = __webpack_require__(33);
...
var _Object$defineProperty = __webpack_require__(96);
...
$export($export.S + $export.F * !__webpack_require__(5), 'Object', { defineProperty: __webpack_require__(1).f });
...
var inspect = __webpack_require__(48);
var config = __webpack_require__(31);
...
var _chai = __webpack_require__(109);

var _interfacePrototype = __webpack_require__(52);

describe('instanceOf implemented class', function () {
  var I = new _interfacePrototype.Interface();
  it('sould be instanceof I', function () {
    var _dec, _class, _dec2, _class2;

    var A = (_dec = (0, _interfacePrototype.instanceOf)(I), _dec(_class = function A() {
      (0, _classCallCheck2.default)(this, A);
    }) || _class);
    var B = (_dec2 = (0, _interfacePrototype.instanceOf)(I), _dec2(_class2 = function B() {
      (0, _classCallCheck2.default)(this, B);
    }) || _class2);
    var a = new A();
    var b = new B();
    (0, _chai.expect)(a).instanceof(I);
    (0, _chai.expect)(b).instanceof(I);
  });
  it('sould not be instanceof I', function () {
    ...
    var a = new A();
    var b = new B();
    (0, _chai.expect)(a).not.instanceof(I);
    (0, _chai.expect)(b).not.instanceof(I);
  });
});
describe('custom callback type check via instanceof operator', function () {
  it('sould be instanceof String', function () {
    var StringInstance = new _interfacePrototype.Interface(function (val) {
      return typeof val === 'string';
    });
    (0, _chai.expect)('foo' instanceof StringInstance).equal(true);
    (0, _chai.expect)('bar' instanceof StringInstance).equal(true);
  });
  it('sould not be instanceof String', function () {
    var StringInstance = new _interfacePrototype.Interface(function (val) {
      return typeof val === 'string';
    });
    (0, _chai.expect)(1 instanceof StringInstance).equal(false);
    (0, _chai.expect)(2 instanceof StringInstance).equal(false);
  });
});
describe('mixed implemented + custom callback', function () {
  var _dec3, _class3;

  var Mixed = new _interfacePrototype.Interface(function (val) {
    return val === 123;
  });
  var A = (_dec3 = (0, _interfacePrototype.instanceOf)(Mixed), _dec3(_class3 = function A() {
    (0, _classCallCheck2.default)(this, A);
  }) || _class3);
  ...
  it('sould be instanceof Mixed', function () {
    (0, _chai.expect)(123 instanceof Mixed).equal(true);
  });
  it('sould be instanceof Mixed', function () {
    var a = new A();
    (0, _chai.expect)(a instanceof Mixed).equal(true);
  });
  it('sould not be instanceof Mixed', function () {
    (0, _chai.expect)(456 instanceof Mixed).equal(false);
  });
  it('sould not be instanceof Mixed', function () {
    var b = new B();
    (0, _chai.expect)(b instanceof Mixed).equal(false);
  });
});
describe('check class is an interface', function () {
  var I = new _interfacePrototype.Interface();
  it('sould be instanceof InterfacePrototype', function () {
    (0, _chai.expect)(I.prototype).instanceof(_interfacePrototype.InterfacePrototype);
  });
});
...
var pathval = __webpack_require__(111);
...
exports.type = __webpack_require__(99);

/*!
 * expectTypes utility
 */
exports.expectTypes = __webpack_require__(114);

/*!
 * message utility
 */

exports.getMessage = __webpack_require__(115);

/*!
 * actual utility
 */

exports.getActual = __webpack_require__(101);

/*!
 * Inspect util
 */

exports.inspect = __webpack_require__(48);
...
exports.eql = __webpack_require__(117);
...
exports.getName = __webpack_require__(102);
...
exports.compareByInspect = __webpack_require__(124);

/*!
 * Get own enumerable property symbols method
 */

exports.getOwnEnumerablePropertySymbols = __webpack_require__(105);

/*!
 * Get own enumerable properties method
 */

exports.getOwnEnumerableProperties = __webpack_require__(125);

/*!
 * Checks error against a given set of criteria
 */

exports.checkError = __webpack_require__(126);

/*!
 * Proxify util
 */

exports.proxify = __webpack_require__(51);

/*!
 * addLengthGuard util
 */

exports.addLengthGuard = __webpack_require__(50);

/*!
 * isProxyEnabled helper
 */

exports.isProxyEnabled = __webpack_require__(49);

/*!
 * isNaN method
 */

exports.isNaN = __webpack_require__(127);
...
var AssertionError = __webpack_require__(100);
var flag = __webpack_require__(12);
...
var flag = __webpack_require__(12)
  , getActual = __webpack_require__(101)
...
var addLengthGuard = __webpack_require__(50);
var chai = __webpack_require__(30);
var flag = __webpack_require__(12);
var proxify = __webpack_require__(51);
var transferFlags = __webpack_require__(32);
...
var getOwnEnumerablePropertySymbols = __webpack_require__(105);
